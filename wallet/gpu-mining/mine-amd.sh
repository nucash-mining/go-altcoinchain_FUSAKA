#!/bin/bash
# AMD GPU Mining Script for Altcoinchain
# Uses OpenCL for mining

WALLET_ADDRESS="${1:-0x8324FA247756a9D2Be9D16884f620e65a142E514}"
RPC_URL="http://127.0.0.1:8545"

echo "=========================================="
echo "  Altcoinchain AMD GPU Miner"
echo "=========================================="
...
echo "Starting AMD GPU miner..."
echo "Press Ctrl+C to stop"
echo ""

# Start ethminer with OpenCL
ethminer -G -P $RPC_URL --report-hashrate
